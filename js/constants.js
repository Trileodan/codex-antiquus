...
const SETS = {
  ...
  "ancient-greece": { id: "ancient-greece", world: "ancient", name: "Ancient Greece", status: "sealed", preview: true,
    tagline: "Philosophy, the polis, and the world Rome inherited.",
