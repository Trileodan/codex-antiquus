...
const SOURCES = {
  ...
  /* ---- Ancient Egypt ---- */
  manetho: "Manetho, Aegyptiaca (3rd c. BC, surviving only in later quotation)",
  "king-lists": "The Turin Canon, the Palermo Stone and the Abydos king list",
  "wadi-jarf": "The Wadi al-Jarf papyri, including the diary of the inspector Merer",
  "pyr-texts": "The Pyramid Texts and Coffin Texts",
  ipuwer: "The Admonitions of Ipuwer (a literary lament, not a report)",
  sinuhe: "The Tale of Sinuhe",
  amarna: "The Amarna letters (382 diplomatic tablets in Akkadian)",
  kadesh: "Ramesses II's Kadesh inscriptions, and the Egyptian-Hittite treaty",
  "medinet-habu": "The reliefs and inscriptions of Ramesses III at Medinet Habu",
  ugarit: "The last archives of Ugarit, baked hard by the fire that destroyed it",
  wenamun: "The Report of Wenamun",
  "deir-el-medina": "The ostraca and papyri of the Deir el-Medina workmen's village",
  "edwin-smith": "The Edwin Smith surgical papyrus",
  "linear-b": "The Linear B tablets of Pylos, Knossos and Mycenae",
  radiocarbon: "Radiocarbon, dendrochronology and Nile flood records",
...
const SETS = {
  ...
  "ancient-egypt": { id: "ancient-egypt", world: "ancient", name: "Ancient Egypt", status: "open",
    foundation: true, patron: "narmer",
    tagline: "c. 3100 – 332 BC. Three thousand years, recorded almost entirely by a state describing its own order, and checked by the paperwork nobody meant to keep." },
