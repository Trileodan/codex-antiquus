...
const CAMPAIGNS = [
  ...
  },
  {
    ...
    stops: [
      { chapter: "grk-thebes-macedon", why: "Before Alexander there is his father, who built the army, the money and the method. Alexander inherited a machine and gets the credit for it." },
      { chapter: "per-darius-iii-alexander", why: "Cross the line and look from the other side. The empire he destroyed was not decadent or doomed — it was the largest and best-run state in the world." },
      { chapter: "egy-from-libyans-persians", why: "Egypt does not fight him. He sacrifices to the Apis bull, is crowned pharaoh, visits an oracle in the desert and comes back declining to say what he was told." },
      { chapter: "ptol-ptolemy-takes-egypt", why: "He dies at thirty-two with no plan. One of his generals steals the body, takes Egypt, and founds a dynasty on an act of theatre." },
      { chapter: "ptol-cleopatra-caesar", why: "Three hundred years later the last of that line is a Macedonian queen speaking Egyptian, and she needs a Roman." },
  ...
  },
  {
    ...
    stops: [
      { chapter: "brit-stonehenge-monument-world", why: "Start with the largest structures in prehistoric Europe, built by people whose language, names and beliefs are entirely lost." },
      { chapter: "brit-island-before-written-history", why: "The first person to write anything about Britain sailed there around 325 BC and was called a liar for six hundred years — about things he got right." },
      { chapter: "brit-bronze-gives-way-iron", why: "By the time Rome arrives the south-east has kings, mints, treasuries and Latin lettering. The wilderness in the Roman account is a literary device." },
      ...
      { chapter: "brit-boudica-burns-roman-britain", why: "The most famous Briton in history is known entirely from two Roman accounts written by men who thought her cause was just and her methods barbaric." },
      { chapter: "brit-410-rome-leaves-sort", why: "And the ending, which was not an event. Nobody in Britain woke up one morning in a post-Roman world." },
    ],
  },
  {
    ...
    stops: [
      { chapter: "grk-mycenae-warrior-kings", why: "First, what was actually there — palaces, kings, tax records and writing, five hundred years before anything you think of as Greek." },
      { chapter: "egy-ramesses-ii-kadesh", why: "And the world it belonged to: two superpowers signing a peace treaty that survives in both their languages, seventy years before one of them ceased to exist." },
      { chapter: "egy-ramesses-iii-sea-peoples", why: "Then it goes. Egypt is the only major power that both survived and left an account, and its account is carved on a temple wall." },
      ...
      { chapter: "grk-after-palaces", why: "Four centuries later something completely different grows in the space: several hundred small states of citizens, with no palace and no king." },
    ],
  },
];
